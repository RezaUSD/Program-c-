	...
	while (selesai==false){
		...
		if (pilih[i]<=10){
			...
			if (pilih[i]==0){
				...
				switch (pilih[i]){
				case 1 : menu[i]="Holder HP"; harga[i]=100000; diskon[i]=0; break;
				case 2 : menu[i]="Mouse"; harga[i]=150000; diskon[i]=0.1; break;
				case 3 : menu[i]="Keyboard"; harga[i]=500000; diskon[i]=0; break;
				case 4 : menu[i]="Headset"; harga[i]=400000; diskon[i]=0.1; break;
				case 5 : menu[i]="Microphone"; harga[i]=250000; diskon[i]=0.05; break;
				case 6 : menu[i]="Hardisk"; harga[i]=900000; diskon[i]=0.1; break;
				case 7 : menu[i]="Flashdisk"; harga[i]=150000; diskon[i]=0; break;
				case 8 : menu[i]="Charger"; harga[i]=200000; diskon[i]=0.1; break;
				case 9 : menu[i]="Case HP"; harga[i]=105000; diskon[i]=0; break;
				case 10 : menu[i]="Mouse Pad"; harga[i]=100000; diskon[i]=0.1; break;
					default : menu[i]=""; harga[i]=0;diskon[i]=0;break;
				}
